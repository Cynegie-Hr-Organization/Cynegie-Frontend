...
const CandidateCard: React.FC<{ candidate: CandidateResponse | null }> = ({
  candidate,
}) => {
  return (
    <div className="flex flex-col justify-between gap-8 bg-white">
      <div className="flex items-center">
        <Avatar alt="Profile" sx={{ width: 50, height: 50, marginRight: 2 }} />
        <div>
      ...
      <div className="flex w-full items-end md:justify-end space-x-4">
        <button className="flex flex-row items-center gap-2 md:w-auto px-6 py-2 border-[#0035C3] border-2 text-sm font-semibold bg-white text-[#0035C3] rounded-lg hover:border-blue-600 cursor-pointer">
          <svg
            width="21"
            height="21"
            viewBox="0 0 21 21"
