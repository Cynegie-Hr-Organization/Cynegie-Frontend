...
const WithdrawModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-white w-[90%] max-w-md md:max-w-xl p-6 rounded-lg shadow-lg relative">
        ...
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-xl font-semibold text-gray-900">Withdraw Offer  </h2>
          <button
            onClick={onClose}
...
Withdrawing an offer will notify candidate and close this offer               </p>
