...
const HrAdminHiringJobOfferDetails: React.FC = () => {
     ...
     <div className="p-[15px]  flex gap-4 flex-col md:p-[30px]">
      <div className="flex  justify-start items-center gap-2">
        <Image
          ...
          onClick={() => router.back()}
        />
        <h1 className="text-base text-gray-500 font-semibold">Back to Offer Management  </h1>
      </div>
          <div className="space-y-6 bg-white p-4 md:p-6 rounded-md ">
  <h2 className="text-lg font-bold text-gray-900 mb-6">Job Offer Details</h2>

  <div className="grid grid-cols-2 md:grid-cols-6 gap-6 mb-6">
    <div className="">
      <p className="text-sm text-gray-500">Job Title</p>
      <p className="text-base font-medium text-gray-900">Product Designer</p>
    </div>
    <div>
    ...
    <div>
      ...
      <p className="text-base font-medium text-gray-900">November 15, 2024</p>
    </div>
    <div>
    ...
    <div>
      ...
      <p className="text-base font-medium text-gray-900">Emmanuel Jacob</p>
    </div>
    <div>
    ...
    <div>
      ...
      <p className="text-base font-medium text-gray-900">Emmanuel@gmail.com</p>
    </div>
    <div>
  ...
  <div className="mb-6">
    ...
    <ul className="text-sm text-gray-700 space-y-1">
      <li>
        <span className="font-semibold">Competitive salary:</span> Base Salary
        3,000,000
      </li>
      <li>
        <span className="font-semibold">Performance bonuses:</span> Incentives
        tied to individual or team performance, such as sales targets or
        campaign results.
      </li>
      <li>
  ...
  <div>
    <h3 className="text-base font-bold text-gray-900 mb-3">Offer Letter</h3>
    <a
      href="#"
      className="text-sm text-blue-600 w-fit rounded-full p-[2px] px-2 bg-blue-50 hover:underline flex items-center"
    >
