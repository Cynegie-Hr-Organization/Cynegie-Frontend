...
const JobsTabTable = <T extends Record<string, any>>({
  data,
  columns,
  totalItems,
  itemsPerPage,
            ...
            {data.map((row, rowIndex) => (
              <tr key={rowIndex} className="border-b hover:bg-gray-50">
                {columns.map((column, colIndex) => (
                 ...
                 {showActions && (
                  <td className="p-2 pr-2 items-end justify-center flex">
                    <div
                      className="relative"
ref={(el) => {
                actionDropdownRefs.current[rowIndex] = el;
                      ...
                      {actionDropdowns[rowIndex] && (
                        ...
                        >
                          <ul>
                            <li className="p-2 hover:bg-gray-100" onClick={() => router.push('/hr-admin/hiring/job-details')}>View job details </li>
                            <li
                              className="p-2 hover:bg-gray-100" onClick={() => router.push('/hr-admin/hiring/edit-job')}>Edit Job
                            </li>
                             <li className="p-2 hover:bg-gray-100 text-red-500" onClick={handleDeleteClick} >Delete Job</li>
