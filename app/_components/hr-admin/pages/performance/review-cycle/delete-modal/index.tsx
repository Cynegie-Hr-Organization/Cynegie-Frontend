...
import { deleteReviewCycle } from "@/app/api/services/performance/review cycle";
...
const DeleteReviewModal: React.FC<ModalProps> = ({
  ...
  const handleDelete = async () => {
    try {
      setIsDeleting(true);
      await deleteReviewCycle(reviewId);
      onClose();
    } catch (error) {
    ...
    >
      ...
      >
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-2">
          Are you sure you want to delete this review cycle?
        </h2>
