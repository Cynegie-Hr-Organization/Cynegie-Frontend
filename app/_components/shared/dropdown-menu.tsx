    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <div className={`flex flex-col gap-2 ${width}`}>
        ...
        <DropdownMenuTrigger asChild>
          <button
            className={`${triggerStyle} relative h-10 w-full rounded-md border bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50`}
          >
        ...
        <DropdownMenuContent
          className={cn("bg-white rounded-lg p-2 w-full", width)}
            ...
            <DropdownMenuGroup className="max-h-[200px] overflow-y-auto w-full multi-select">
              <DropdownMenuItem
                ...
                onClick={(e) => {
                  ...
                  const newSelected =
                    selectedValues.length === items.length ? [] : allValues;
