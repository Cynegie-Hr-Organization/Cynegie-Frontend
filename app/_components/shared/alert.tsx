...
export function AppAlertDialog({ children, header, description, cancelText, confirmText, cancelAction, confirmAction }: {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent className="">
        ...
        <AlertDialogFooter className="flex items-center sm:justify-center mt-5">
          ...
          <AlertDialogAction className="btn-primary text-white" onClick={confirmAction}>{confirmText}</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  )
