...
const AppMenubar = ({
  ...
  return (
    <Menubar className={cn("w-fit h-fit", overrideClassName, className)}>
      <MenubarMenu>
        <MenubarTrigger className="px-1 py-1 rounded-md cursor-pointer hover:bg-gray-50/50 data-[state=open]:bg-gray-50/50">
          {children}
        </MenubarTrigger>
        <MenubarContent
          align="end"
