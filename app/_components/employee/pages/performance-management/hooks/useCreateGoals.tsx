  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response?.status === 201) {
        ...
        setTimeout(() => router.push("/employee/performance-management"), 2000);
      } else {
...
const MilestoneForm = ({
  ...
  return { pageProps , PerformanceGoalsCreatePage};
};



export default useEmployeeCreateGoal;