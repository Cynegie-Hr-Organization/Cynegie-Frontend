...
import { AttendanceResponse, clockIn, clockOut, fetchAttendanceMine } from '@/app/api/services/employee/attendance';
...
const useClockInOut = () => {
  ...
  const handleClockOut = async () => {
    try {
      const attendanceResponse: AttendanceResponse = await fetchAttendanceMine();
