...
import { employeeMyCoursesTableData } from './data';
import { useRouter } from 'next/navigation';
import { Input, InputGroup } from 'rsuite';
import 'rsuite/dist/rsuite.min.css';

const EmployeeMyCoursesTable = () => {
        ...
        <Table>
          <TableHead sx={{ backgroundColor: '#F7F9FC' }}>
            <TableRow>
              ...
              {['Course Title', 'Progress', 'Next Lesson', 'Actions'].map(
                (field) => (
          ...
          <TableBody>
            {employeeMyCoursesTableData.map((row, rowIndex) => (
              <TableRow key={rowIndex}>
                ...
                {[row.title, row.progress, row.nextLesson].map(
                  (field, columnIndex) =>
                    columnIndex == 1 ? (
                      <TableCell
                  ...
                  <Button
                    onClick={(e) => {
                      ...
                      setTableActionPopoverContent([
                        { name: 'Continue Course', route: '' },
                        { name: 'View Details', route: '' },
                        { name: 'Mark As Completed', route: '' },
                      ]);
                    }}
                  >
                    <MoreVert
...
export default EmployeeMyCoursesTable;
