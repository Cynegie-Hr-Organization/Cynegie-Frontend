...
import { payrollActivitiesTableData } from './data';

import 'rsuite/dist/rsuite.min.css';

const PayrollActivitiesTable: React.FC<{
        ...
        <Table>
          <TableHead sx={{ backgroundColor: '#F7F9FC' }}>
            <TableRow>
              ...
              {['Pay Date', 'Name', 'Total Amount', 'Net Pay'].map((field) => (
          ...
          <TableBody>
            {payrollActivitiesTableData.map((row, rowIndex) => (
              <TableRow key={rowIndex}>
                ...
                {[row.payDate, row.name, row.totalAmount, row.netPay].map(
                  (field, columnIndex) => (
...
export default PayrollActivitiesTable;
