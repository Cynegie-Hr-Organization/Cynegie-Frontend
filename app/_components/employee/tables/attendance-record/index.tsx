...
import { employeeAttendanceRecordTableData } from './data';
import AttendanceDetailsModal from '../../modals/attendance-details';
import RequestCorrectionModal from '../../modals/request-correction';
      ...
      <Stack gap={2} className='common-card'>
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {employeeAttendanceRecordTableData.map((row, rowIndex) => (
