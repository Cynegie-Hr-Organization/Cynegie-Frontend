...
import { notificationsTableData } from './data';
import { useRouter } from 'next/navigation';
import { Input, InputGroup } from 'rsuite';
import 'rsuite/dist/rsuite.min.css';
import ViewNotificationModal from '../../modals/view-notification';
...
const NotificationsTable = () => {
  ...
  const [openViewNotificationModal, setOpenViewNotificationModal] =
    useState(false);

  return (
    <>
      <Stack gap={2} mb={10} className='common-table-card'>
        <Stack
          sx={{
          ...
          <Table>
            <TableHead sx={{ backgroundColor: '#F7F9FC' }}>
              <TableRow>
                ...
                {['Notification', 'From', 'Details', 'Date', 'Actions'].map(
                  (field) => (
            ...
            <TableBody>
              {notificationsTableData.map((row, rowIndex) => (
                <TableRow key={rowIndex}>
                  ...
                  {[row.name, row.from, row.details, row.date].map(
                    (field, columnIndex) => (
                      <TableCell
          ...
          <Stack padding={5} gap={5}>
            <Stack gap={3}>
              <Stack gap={1}>
                ...
                >
                  <MenuItem value='All'>Victor</MenuItem>
              ...
              <Stack gap={1}>
                ...
                <Select
                  ...
                  sx={{ height: '40px', borderRadius: '5px', width: '200px' }}
                >
                  <MenuItem value='All'>30 July 2024</MenuItem>
      ...
      <ViewNotificationModal
        ...
        onCloseFn={() => setOpenViewNotificationModal(false)}
      />
    </>
  );
};
