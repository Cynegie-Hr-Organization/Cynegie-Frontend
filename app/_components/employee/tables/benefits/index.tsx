...
import { benefitsTableData } from './data';
import ViewBenefitDetailsModal from '../../modals/view-benefit-details';
...
const EmployeeBenefitsTable = () => {
  ...
  return (
    <>
      <Stack gap={2} className='common-card'>
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {benefitsTableData.map((row, rowIndex) => (
      ...
      <ViewBenefitDetailsModal
        open={openDetailsModal}
        onCloseFn={() => setOpenDetailsModal(false)}
      />
    </>
  );
};
