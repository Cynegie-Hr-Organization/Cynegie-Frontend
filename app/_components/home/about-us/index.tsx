...
const LocationCard = ({
  ...
  return (
    <div className="w-full p-[2vw] bg-white  max-w-[45%] lg:max-w-xs rounded-[2vw] lg:rounded-2xl border">
      <img
        src={flag}
        alt="flag"
        className="w-[2vw] min-w-3 max-w-5 text-gray-700"
      />
      <h3 className="mt-1 lg:text-lg text-[3vw] font-bold text-black">
        {name}
      </h3>
  ...
  return (
    <div>
      ...
      <div className="p-8 bg-gray-100/30">
        ...
        <p className="mt-10 text-2xl text-center text-gray-600">
