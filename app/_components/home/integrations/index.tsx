  ...
  return (
    <div className="bg-[#F8F9F9]">
      <div className="">
          ...
          <PageTitleComponents
            ...
            subtitle={
              <p className="text-DreamyCloud text-lg font-sans font-normal text-left md:text-center mt-5">
                Tell us which service you’d love to use and we’ll send a custom
                code.
              </p>
            }
          >
            Cynegie API Connections for{" "}
            <span className="text-MaximumYellowRed">Employee Services</span>
          </PageTitleComponents>
          <button className="text-DarkRift bg-ChefsHat text-smr px-10 py-2 md:px-40 rounded-lg font-bold mt-14">
            Request Now{" "}
          </button>
        </div>
        ...
        <p className="text-xl hidden md:block font-semibold font-roboto px-32 text-Charcoal my-5">
          All Apps
        </p>
        ...
        <div className="md:px-32 px-5 mt-10 flex flex-wrap md:gap-40 gap-5 justify-center">
          {integrationData.map((data: IntegrationData, index: number) => (
            <div
              key={index}
              className="w-[168px] md:w-[272px] md:px-5 md:py-8 md:pb-16 flex flex-col gap-3 bg-white text-Charcoal px-2 py-5 shadow-xl"
            >
              <img
        ...
        <section
          className={"bg-PersianBlue mt-32 py-32 relative px-5 lg:pl-10"}
        >
          <div className={"max-w-7xl mx-auto"}>
            ...
            >
              <div>
                <PageTitleComponents
                  ...
                  subtitle={
                    ...
                    >
                      Request a free, personalized demo, and discover how
                      Cynergie can transform your workforce management. Tailored
                      for businesses of any size, our platform simplifies
                      workflows and empowers your teams.
                    </p>
                  }
                  className={
              ...
              {/*  image  */}
              <figure
                className={"lg:absolute lg:bottom-0 lg:right-0 lg:hidden"}
              >
                <img
              ...
              <figure
                className={
                  " hidden lg:absolute lg:bottom-0 lg:right-0 lg:block"
                }
              >
                <img
