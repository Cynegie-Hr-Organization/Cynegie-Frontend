...
import ViewDetailsModal from "../view-software-modal"; // Import your modal component
...
const SoftwareManagementTabTable = <T extends Record<string, any>>({
  data,
  columns,
  totalItems,
  itemsPerPage,
...
export default SoftwareManagementTabTable;
