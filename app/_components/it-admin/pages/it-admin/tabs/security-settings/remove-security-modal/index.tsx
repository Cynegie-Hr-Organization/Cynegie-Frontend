...
import { deleteSecurityAlerts } from "@/app/api/services/it-admin"; // Replace with correct path
...
const RemoveSecurityModal: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  rowData,
  onRemoveSuccess,
  ...
  const handleRemove = async () => {
    ...
    try {
      console.log("Attempting to delete alert with ID:", rowData);
      const res = await deleteSecurityAlerts(rowData);
      console.log(res);
      ...
      if (onRemoveSuccess) {
        onRemoveSuccess(); // Refresh data or perform other actions
      }
    } catch (error) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      >
        ...
        <p className="text-sm text-gray-600 mb-6">
          Deleting this alert will remove it permanently for all users.
        </p>
...
export default RemoveSecurityModal;
