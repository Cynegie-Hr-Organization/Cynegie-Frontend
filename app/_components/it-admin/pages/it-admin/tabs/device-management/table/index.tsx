...
import ViewDetailsModal from "../view-device-modal"; // Import your modal component
...
const DeviceManagementTabTable = <T extends Record<string, any>>({
  data,
  columns,
  totalItems,
  itemsPerPage,
...
export default DeviceManagementTabTable;
