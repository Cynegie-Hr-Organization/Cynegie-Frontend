...
import DeviceManagementTabTable from "./table";
import { getDeviceManagement } from "@/app/api/services/it-admin";
...
const DeviceManagementTab: React.FC = () => {
  ...
  const columns = [
    {
      header: "Device Name",
      accessor: (row: Device) => row.deviceName,
    },
    {
      header: "Description",
      accessor: (row: Device) => row.description,
    },
    {
      header: "Location",
      accessor: (row: Device) => row.location,
    },
    {
      header: "Status",
      accessor: (row: Device) => (
            ...
            <div className="absolute bg-white shadow-lg border border-gray-300 w-44 rounded-md md:w-72 mt-1 p-2 md:p-4 z-10 right-0">
              <div className="py-1">
                <div className="py-1">
                  <Dropdown
                    label="Status"
                    options={["ACTIVE", "INACTIVE", "UNDER-REPAIR"]}
