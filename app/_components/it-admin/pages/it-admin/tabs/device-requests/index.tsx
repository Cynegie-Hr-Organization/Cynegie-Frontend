...
import DeviceRequestsTabTable from "./table";
import { getDeviceRequests } from "@/app/api/services/it-admin";
...
const DeviceRequestsTab = () => {
  ...
  const columns = [
    {
      header: "Request ID",
      accessor: (row: DeviceRequest) => row.id,
    },
    {
      header: "Name",
    ...
    {
      header: "Requested Device",
      accessor: (row: DeviceRequest) => row.deviceId.deviceName,
    },
    {
...
export default DeviceRequestsTab;
