import {
  ...
  IPayroll,
} from "@/app/_core/actions/finance/payroll";
  ...
  const rejectPayroll = useMutation({
    ...
    mutationFn: async ({
      ...
      if (!id || !rejectionReason)
        throw new Error("id and rejection reason is required");
