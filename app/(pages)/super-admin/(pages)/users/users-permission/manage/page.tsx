    ...
    <div className="space-y-6 py-6">
      <div>
        ...
        <p className="text-xs text-gray-500">
          Manage users information and permission
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <AppSelect
              ...
              onChange={(value) =>
                setFormData({ ...formData, role: value as UserRoles })
              }
            />
          </div>
        </div>
        ...
        <div>
          {formData.role === "finance-admin" && (
            <PermissionOptionLayout
              fullAccessChecked={
                formData.financeAdminSwitches.accessType.fullAccess
              }
              limitAccessChecked={
                formData.financeAdminSwitches.accessType.limitAccess
              }
              viewOnlyChecked={
                formData.financeAdminSwitches.accessType.viewOnlyAccess
              }
          ...
          {formData.role === "hr-admin" && (
            <PermissionOptionLayout
              ...
              limitAccessChecked={
                formData.hrAdminSwitches.accessType.limitAccess
              }
              viewOnlyChecked={
                formData.hrAdminSwitches.accessType.viewOnlyAccess
              }
              onPermissionChange={(value) =>
                handleAccessTypeChange(value as AccessType)
              }
              disabled={!formData.role}
            >
              <HRAdminOptions
                isDisabledSwitches={
                  formData.hrAdminSwitches.accessType.viewOnlyAccess ||
                  formData.hrAdminSwitches.accessType.fullAccess
                }
          ...
          {formData.role === "it-admin" && (
            <PermissionOptionLayout
              ...
              limitAccessChecked={
                formData.itAdminSwitches.accessType.limitAccess
              }
              viewOnlyChecked={
                formData.itAdminSwitches.accessType.viewOnlyAccess
              }
              onPermissionChange={(value) =>
                handleAccessTypeChange(value as AccessType)
              }
            ...
            >
              <ITAdminOptions
                isDisabledSwitches={
                  formData.itAdminSwitches.accessType.viewOnlyAccess ||
                  formData.itAdminSwitches.accessType.fullAccess
                }
