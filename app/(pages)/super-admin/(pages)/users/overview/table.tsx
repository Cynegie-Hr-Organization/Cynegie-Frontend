...
import {
  ...
  useEmployees,
} from "@/app/_core/use-cases/user/employee";
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 capitalize">
                          <p className="text-sm">
                            {personalInfo?.firstName ?? "NIL"}{" "}
                            {personalInfo?.lastName ?? "NIL"}
                          </p>
                        </td>
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-x-2">
                            ...
                            <p className="text-sm">
                              {employmentInformation?.jobTitle ?? "NIL"}
                            </p>
                          </div>
                        </td>
                        <td className="px-4 py-4">
                          <p
                            className={`text-xs font-semibold ${getStatusColor(employmentInformation?.employmentStatus)} rounded-full px-2 py-1 w-fit text-nowrap`}
                          >
    ...
    <>
      ...
      >
        ...
        <PopoverContent className="w-40 p-2 bg-white cursor-pointer rounded-lg flex flex-col items-start text-[#475367]">
          <button
            onClick={() =>
              router.push(`/super-admin/users/overview/${user?.id}`)
            }
          ...
          <span className="flex flex-col items-center justify-center gap-y-6">
            ...
            <span className="flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-sm font-normal text-black max-w-[367px] text-center">
                If you delete this user record, it will be removed from the
                database list and it will be inaccessible
              </span>
            </span>
          </span>
        </span>
