...
const gradientChartData: GradientChart[] = [
  { month: "Jan", completed: 150, inProgress: 80, due: 45, notStarted: 65 },
  { month: "Feb", completed: 200, inProgress: 90, due: 55, notStarted: 70 },
  { month: "Mar", completed: 180, inProgress: 85, due: 50, notStarted: 60 },
  { month: "Apr", completed: 135, inProgress: 95, due: 60, notStarted: 75 },
  { month: "May", completed: 209, inProgress: 100, due: 65, notStarted: 80 },
  { month: "Jun", completed: 214, inProgress: 110, due: 70, notStarted: 85 },
  { month: "Jul", completed: 300, inProgress: 120, due: 75, notStarted: 90 },
  { month: "Aug", completed: 350, inProgress: 130, due: 80, notStarted: 95 },
  { month: "Sep", completed: 250, inProgress: 115, due: 70, notStarted: 85 },
  { month: "Oct", completed: 200, inProgress: 105, due: 65, notStarted: 80 },
  { month: "Nov", completed: 220, inProgress: 100, due: 60, notStarted: 75 },
  { month: "Dec", completed: 240, inProgress: 95, due: 55, notStarted: 70 }
];

const piechartData = [
  { task: "completed", value: 240, fill: colors.grey },
  { task: "due", value: 55, fill: colors.blue },
  { task: "inProgress", value: 95, fill: colors.yellow },
  { task: "notStarted", value: 70, fill: colors.green }
];
  ...
  return (
    <div className="space-y-8 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
        ...
        <PieChartCard className="col-span-1 md:col-span-2 lg:col-span-4 xl:col-span-3 h-auto" chartData={gradientChartData} />
