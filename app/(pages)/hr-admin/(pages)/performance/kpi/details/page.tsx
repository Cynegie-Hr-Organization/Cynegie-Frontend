...
const KpiDetailsPage = () => {
  ...
  const { data: trainingCompletionRate, isLoading: isTrainingLoading } =
    useQuery({
      queryKey: ["trainingCompletionRate"],
      queryFn: getTrainingCompletionRate,
    });

  // Fetch monthly training completion data
  ...
  return (
    <div className="space-y-6 mb-12">
      ...
      <PageHeader title="KPI Details" buttonLabel="Export Data" />
            ...
            <div className="common-card space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Measures the percentage of employees who have completed their
              ...
              <p className="flex items-center gap-6">
                ...
                <span className="font-bold text-primary">
                  {isTrainingLoading ? (
                    ...
                    `${trainingCompletionRate?.completionRate || "N/A"}%`
                  )}
                </span>
              </p>
            </div>
