...
const EmployeeReviewPage = () => {
  ...
  const { activeStep, setActiveStep, refs, containerRef, sliderRef } =
      ...
      <CardLayout className="mt-6 p-6 lg:p-[55px] space-y-12">
        ...
        <div className="space-y-12">
          <EmployeeDetailLong
            ...
            subTitle="Okeke exceeded expectations on sales targets but could improve customer satisfaction "
          />
          <EmployeeDetailLong
            title="Employee Self Assessment e"
            subTitle="Sales Associate "
          />
