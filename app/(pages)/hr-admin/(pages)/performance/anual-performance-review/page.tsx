      ...
      <div className='flex flex-col justify-center gap-y-8 h-full'>
        <div className='flex flex-col lg:flex-row gap-8 lg:items-center'>
          ...
          <div className='flex flex-col gap-y-2 font-semibold'>
            <p className='text-sm text-gray-700 flex items-center gap-x-2'>
              <GoDotFill style={{ color: colors.green }} />
              20 Completed Reviews
            </p>
            <p className='text-sm text-gray-700 flex items-center gap-x-2'>
            ...
            <p className='text-sm text-gray-700 flex items-center gap-x-2'>
              <GoDotFill style={{ color: colors.yellow }} />5 Closed Review
            </p>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-y-1 font-semibold'>
          ...
          <p className='text-sm text-gray-700 text-right uppercase'>
            50% complete
          </p>
        </div>
      </div>
...
const EmployeesTable = () => {
  // const router = useRouter(); Unused variable commented out
  return (
                  ...
                  >
                    ...
                    <td className='px-4 py-4'>
                      <p className='text-sm truncate'>
                        Achieve 10% growth in Q1 sales +2
                      </p>
                    </td>
                    <td className='px-4 py-4'>
