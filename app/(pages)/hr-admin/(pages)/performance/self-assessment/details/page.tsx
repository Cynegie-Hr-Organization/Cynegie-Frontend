  ...
  return (
    <div className="space-y-6 py-6">
      <div className="flex items-center justify-between">
        <button className="flex items-center gap-2 text-gray-500 cursor-pointer" onClick={() => router.back()}>
          <IoIosArrowBack className="text-xl" />
          <h2 className="">Back</h2>
        </button>

        <DownloadModal trigger={<AppButton label="Download Report" className="btn-primary" />} />
      </div>
      ...
      <CardLayout bg="border-none bg-white p-4 md:p-6 text-sm space-y-6">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-5 gap-6">
          ...
          <PreviewTitle name="Assessment Template" description="Q2 2024 Self Assessment" />
        </div>
      </CardLayout>
        ...
        <div className="flex items-center gap-4 md:gap-[50px] ">
          ...
          <div className="grid grid-cols-2 gap-6 text-sm">
            <p className="font-semibold flex items-center gap-6">
              <span className="flex items-center gap-1"><GoDotFill className="text-blue-700" /> Communication </span>
              <span className="text-sm text-gray-500"> 4.2(22.5%)</span>
            </p>
            <p className="font-semibold flex items-center gap-6">
              <span className="flex items-center gap-1"><GoDotFill className="text-amber-500" /> Leadership </span>
              <span className="text-sm text-gray-500"> 4.0(20.0%)</span>
            </p>
            <p className="font-semibold flex items-center gap-6">
              <span className="flex items-center gap-1"><GoDotFill className="text-green-600" /> Teamwork </span>
              <span className="text-sm text-gray-500"> 4.0(20.0%)</span>
            </p>
            <p className="font-semibold flex items-center gap-6">
              <span className="flex items-center gap-1"><GoDotFill className="text-gray-300" /> Initiative </span>
              <span className="text-sm text-gray-500"> 4.0(20.0%)</span>
            </p>
          </div>
        </div>
...
const PreviewTitle = ({ name, description }: { name: string, description: string }) => {
  return (
