    ...
    <div className="flex items-center justify-between gap-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Manage Feedback of all employee in your organization
        </p>
      </div>
      ...
      <div className="flex items-center gap-x-2">
        <AppDropdownMenu
          ...
          menuItems={
            <div className="p-2">
              <span className="lg:hidden flex items-center gap-x-2 cursor-pointer hover:bg-gray-100 rounded-lg p-2">
                Add New Feedback
              </span>
              <RecognizeAchievementModal
                trigger={
...
const RecognizeAchievementModal = ({
  trigger,
}: {
        ...
        <DialogTitle className="text-lg font-bold text-center">
          <span className="flex flex-col items-center justify-center gap-y-6">
            ...
            <span className="flex flex-col items-center justify-center gap-y-2">
              ...
              <span className="text-sm text-gray-400 max-w-[367px] text-center">
                Deleting this feedback will remove all associated reviews,
