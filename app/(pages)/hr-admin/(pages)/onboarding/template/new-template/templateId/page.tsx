  ...
  return (
    <div className="p-0 md:py-12 md:px-8 space-y-8">
      ...
      <div className="text-sm space-y-2">
        ...
        <p className="text-[#64748B]" >Analytics delivers actionable, industry-ready initiatives each time a business complete their full account. Phasellus vitae amet amet, mauris faucibus at sit. Pellentesque rhoncus adipiscing a enim, quis tortor, non etiam. Eget faucibus mattis consequat dui imperdiet scelerisque. Lorem placerat blandit ut lobortis volutpat convallis libero. Sed imperdiet dignissim ipsum quam.</p>
      </div>
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex gap-x-4">
          ...
          <div className="w-full space-y-2">
            ...
            <p className="font-normal">Almost there <span className="text-primary">@Angela</span>, can you see the comments in Figma now!</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="p-6 mt-5 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs">Analytics delivers actionable, industry-ready initiatives each time a business complete their full account. Phasellus vitae amet amet, mauris faucibus at sit. Pellentesque rhoncus adipiscing a enim, quis tortor, non etiam. Eget faucibus mattis consequat dui imperdiet scelerisque. Lorem placerat blandit ut lobortis volutpat convallis libero. Sed imperdiet dignissim ipsum quam.</p>
      </div>
