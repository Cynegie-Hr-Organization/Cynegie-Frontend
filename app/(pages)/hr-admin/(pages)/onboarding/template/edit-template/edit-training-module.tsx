  ...
  return (
    <div className='p-[14px] bg-white rounded-lg h-max w-full lg:hidden space-y-3'>
      <div className=' flex items-start justify-between'>
        ...
        <ViewTaskModal>
          <p className='font-semibold cursor-pointer'>Cybersecurity Awareness Trainingn</p>
        </ViewTaskModal>
      ...
      <div className='p-[14px] flex items-center justify-between'>
        <ViewTaskModal>
          <div className="cursor-pointer max-w-[398px]">
            <p className='font-semibold truncate'>Cybersecurity Awareness Training</p>

            <p className='text-xs text-[#64748B] font-medium truncate'>
              Prepare and configure the new hire&apos;s workstation with all required hardware and software. Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut voluptatibus harum voluptatem. Laborum illo minus cumque nihil, delectus labore ullam fuga obcaecati animi fugit blanditiis, unde impedit, veniam ipsa ea!
              Aliquam, omnis. Illo nobis ullam temporibus sapiente molestias voluptate veritatis voluptas vero. Ipsa, quas deserunt error commodi porro amet rerum omnis consequatur mollitia eos cupiditate praesentium dolor. Eius, consequatur sapiente.
              Voluptatum expedita enim fuga, laboriosam saepe esse culpa! Adipisci nulla officia odit asperiores assumenda unde, quam vero. Aut sequi in ducimus quod mollitia perferendis, est eaque dolorum, ex corrupti eos!
            </p>
          </div>
        </ViewTaskModal>
    ...
    <Popover>
      ...
      <PopoverContent className='w-max bg-white space-y-2 cursor-pointer rounded-lg flex flex-col items-start text-[#475367]'>
        <EditTrainingModuleModal>
          <button type='button' className='text-nowrap text-sm'>Edit Training Module</button>
        </EditTrainingModuleModal>

        <button type='button' className='text-red-500 text-nowrap text-sm'>Delete Training Module</button>
      </PopoverContent>
    </Popover>
  );
}
    ...
    <DrawerDialog
      ...
      header={
        <DialogTitle className='space-y-1'>
          ...
          <p className='font-normal text-sm text-[#64748B]'>Training module details</p>
        </DialogTitle>
      }
    >
      <>
