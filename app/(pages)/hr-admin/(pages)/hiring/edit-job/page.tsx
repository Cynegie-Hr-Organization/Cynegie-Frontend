...
const HiringOverviewEditJobPage = () => {
  ...
  return (
    <>
      {screenInView === 1 && <EditJobForm setScreenInView={setScreenInView} setFormData={setFormData} />}
      {screenInView === 2 && <EditJobPreview setScreenInView={setScreenInView} formData={formData} />}
    </>
  );
};
