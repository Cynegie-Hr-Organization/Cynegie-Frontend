...
import OtherActionsModal, {
  vendorStatus,
} from "@/app/(pages)/finance-admin/(pages)/vendor-management/components/other-actions-modal";
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4 md:gap-0">
        <div className="flex-grow max-w-[300px] xl:max-w-[479px] flex items-center border pl-4 border-gray-300 rounded-lg overflow-hidden transition-all duration-300 focus-within:ring-1 focus-within:border-primary focus-within:ring-primary">
          ...
          <input
            ...
            onChange={(e) =>
              setFilterOverride({ ...filterOverride, search: e.target.value })
            }
          />
        </div>
            ...
            <div className="p-4 space-y-5">
              <div className="space-y-4">
                <AppSelect
                  ...
                  onChange={(value) =>
                    setSelectedStatus(value as IVendorStatus)
                  }
                />
              </div>
  ...
  return (
    <>
      ...
      <OtherActionsModal
        ...
        onClose={() =>
          setModalState({ ...modalState, otherActionsModal: false })
        }
      />
    </>
  );
