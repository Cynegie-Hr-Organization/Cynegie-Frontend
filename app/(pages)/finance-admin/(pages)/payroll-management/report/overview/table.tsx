...
const PayrollReportOverviewTable = () => {
  return (
    <div className="common-card overflow-x-scroll space-y-4">
      ...
      <div className='-mx-5 mt-4'>
        <div className="flex items-center justify-between gap-4 px-4 md:px-5 pb-4">
          <FilterPills filterType="Sales" />
        </div>
...
const FilterPills = ({ filterType }: { filterType: string }) => {
  return (
    <button className='flex items-center gap-2 border border-gray-400 bg-gray-100 font-semibold rounded-lg px-4 py-2'> {filterType} </button>
  )
}
...
export default PayrollReportOverviewTable;