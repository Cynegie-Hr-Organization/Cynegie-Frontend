          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="w-[177px]">
              <AppPieChart
                innerRadius={52}
                chartData={[
                  { task: "gross-pay", value: 2800.0, fill: "#0F973D" },
                  { task: "bonuses", value: 2800.0, fill: "#335DCF" },
                  { task: "taxes", value: 2800.0, fill: "#FFAD33" },
                ]}
...
const ChartDataLabel = ({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <p className="font-roboto text-[#667185] text-sm font-semibold">
        {value}
      </p>
    </div>
  );
