    ...
    <div className="space-y-8">
      ...
      <div className="common-card space-y-8 md:p-10">
        <div className="flex flex-col md:flex-row gap-4">
          <AppSelect
            ...
            listItems={[
              ...
              { label: 'Employee Payroll Details', value: 'employee-payroll-summary' },
        ...
        <div className="space-y-4">
          <p className="font-roboto font-semibold text-base">Employee Filters</p>
        ...
        <div className="space-y-4">
          <p className="font-roboto font-semibold text-base">Report Customization</p>
          <div className="flex flex-col md:flex-row gap-4">
            <AppSelect
      ...
      <FooterButtons
        ...
        onBtn1Click={() => { }}
        onBtn2Click={() => { router.push('/finance-admin/payroll-management') }}
      />
    </div>
