    ...
    <div className="common-card overflow-x-scroll space-y-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4 md:gap-0">
        <div className="space-y-1">
          <h3 className="font-roboto text-xl font-bold">Account Groups</h3>
          <p className="text-sm text-gray-500">
            Listing of reporting groups for all ledgers accounts
          </p>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <AppButton label="New Group" className="btn-primary" />
        </div>
      </div>
...
export const LedgerAccountsTable = () => {
  return (
    <div className="common-card overflow-x-scroll space-y-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full gap-4 md:gap-0">
        <div className="space-y-1">
          <h3 className="font-roboto text-xl font-bold">Ledger Accounts</h3>
          <p className="text-sm text-gray-500">
            Listing of finance account used in the system
          </p>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <NewLedgerAccountModal
            trigger={<AppButton label="New Account" className="btn-primary" />}
          />
        </div>
      </div>
