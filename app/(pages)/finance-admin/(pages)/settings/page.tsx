...
import {
  IFinanceSettings,
  useFinanceSettingsMutations,
} from "@/app/_core/actions/finance/settings";
...
const FinanceAdminSettings = () => {
  const { data: financeSettings, isLoading: isLoadingCurrentSettings } =
    useFinanceSettings();
        ...
        <div className="common-card space-y-8">
            ...
            <AppDatePicker
              ...
              selectedDate={
                formData.fiscalYearStart
                  ? new Date(formData.fiscalYearStart)
                  : undefined
              }
              setSelectedDate={(value) =>
                setFormData({
                  ...formData,
                  fiscalYearStart: value?.toISOString(),
                })
              }
            />
          </div>
          <div className="flex flex-col lg:flex-row items-center justify-center gap-5">
            <AppInputText
              ...
              isLoadingContent={isLoadingCurrentSettings}
              onChange={(e) =>
                setFormData({ ...formData, taxSettings: e.target.value })
              }
            />
            <AppSelect
              ...
              placeholder="Input details"
              onChange={(value) =>
                setFormData({ ...formData, expenseCategories: value })
              }
            />
            <AppSelect
